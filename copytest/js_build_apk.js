...
var arr_cn = ['no-platform', 'cmcc', 'leren', 'tencent', 'cucc', 'zhangle', 'zhangle_yidongMM_sdk', 'zhangle_MyEPay', 'zhangle_cucc', 'zhangle_ctcc', 'yingyongbao', '360sdk', 'ctcc', 'xiaomi', 'Upay', 'All'];
...
var cn_par = {
    properties: {
        part: {
            description: '请选择渠道: [0]空包 [1]移动MM  [2]乐人  [3]腾讯  [4]联通  [5]掌乐  [6]掌乐(移动妹妹)  [7]掌乐(买壹贝)  [8]掌乐(联通)  [9]掌乐(电信)  [10]应用宝  [11]360sdk  [12]电信  [13]小米  [14]优贝  [15]以上所有渠道.\n\n\n\n',
            //default: '0',
            pattern: /^[0-9]{1,2}$/,
...
function loadFiles() {
    if (part == "no-platform") {
        ...
        copyExceptCocosLib('../star/resources/popostar/loading', './assets/res/loading');
         // 拷贝superegg资源
        copyExceptCocosLib('../star/resources/cmcc/sprees', './assets/res/sprees');
    } else if (part == "cmcc") {
        // 拷贝files(来消星星的你)
        ...
        copyExceptCocosLib('../star/resources/popostar/loading', './assets/res/loading');
        // 拷贝superegg资源
        copyExceptCocosLib('../star/resources/cucc/sprees', './assets/res/sprees');
        ...
        copyExceptCocosLib('../star/resources/gogostar1/loading', './assets/res/loading');
        // 拷贝superegg资源
        copyExceptCocosLib('../star/resources/zhangle/sprees', './assets/res/sprees');
        ...
        copyExceptCocosLib('../star/resources/gogostar1/loading', './assets/res/loading');
        // 拷贝superegg资源
        copyExceptCocosLib('../star/resources/zhangle_yidongMM_sdk/sprees', './assets/res/sprees');
        ...
        copyExceptCocosLib('../star/resources/gogostar1/loading', './assets/res/loading');
        // 拷贝superegg资源
        copyExceptCocosLib('../star/resources/zhangle_MyEPay/sprees', './assets/res/sprees');
        ...
        copyExceptCocosLib('../star/resources/gogostar1/loading', './assets/res/loading');
        // 拷贝superegg资源
        copyExceptCocosLib('../star/resources/zhangle_cucc/sprees', './assets/res/sprees');
    } else if (part == "zhangle_ctcc") {
        // 拷贝files(星星去哪儿)        
        copyExceptCocosLib('../thirPart/zhangle_ctcc/src', './src');
        copyExceptCocosLib('../thirPart/zhangle_ctcc/res', './res');
        copyExceptCocosLib('../thirPart/zhangle_ctcc/xml', './');
        copyExceptCocosLib('../thirPart/zhangle_ctcc/libs', './libs');
        copyExceptCocosLib('../thirPart/zhangle_ctcc/assets', './assets');
        // 拷贝icon        
        copyExceptCocosLib('../star/resources/gogostar1/loading', './assets/res/loading');
        // 拷贝superegg资源
        copyExceptCocosLib('../star/resources/zhangle_ctcc/sprees', './assets/res/sprees');
        ...
        //拷贝superegg资源
        copyExceptCocosLib('../star/resources/360pay/sprees', './assets/res/sprees');
    } else if (part == "ctcc") {
        // 拷贝files(来消星星的你)
        ...
        copyExceptCocosLib('../star/resources/popostar/loading', './assets/res/loading');
        // 拷贝superegg资源(超值神奇蛋)
        copyExceptCocosLib('../star/resources/ctcc/sprees', './assets/res/sprees');
    } else if (part == 'ALAO') {
        // 拷贝files(来消星星的你)
        ...
        copyExceptCocosLib('../star/resources/popostar/loading', './assets/res/loading');
        // 拷贝superegg资源
        copyExceptCocosLib('../star/resources/xiaomi/sprees', './assets/res/sprees');
    } else if (part == "Upay") {
        // 拷贝files(来消星星的你)
        copyExceptCocosLib('../thirPart/Upay/src', './src');
        copyExceptCocosLib('../thirPart/Upay/res', './res');
        copyExceptCocosLib('../thirPart/Upay/xml', './');
        copyExceptCocosLib('../thirPart/Upay/libs', './libs');
        copyExceptCocosLib('../thirPart/Upay/assets', './assets');
        // 拷贝icon
        copyExceptCocosLib('../star/resources/popostar/loading', './assets/res/loading');
        // 拷贝superegg资源
        copyExceptCocosLib('../star/resources/Upay/sprees', './assets/res/sprees');
    }
}
